...
export default function NotFound() {
  return (
    <main className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden px-6 text-center">
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_70%_50%_at_50%_0%,rgba(0,212,255,0.07),transparent_60%)]"
      />
      <Constellation className="absolute inset-0 -z-10 h-full w-full" count={50} />

      <div className="ax-metric-label mb-4">signal not found</div>
      ...
      <p className="mt-4 max-w-md text-base leading-relaxed text-fd-muted-foreground">
        This page drifted out of the survey. The coordinates you requested
        don&apos;t match anything in the current constellation.
      </p>
